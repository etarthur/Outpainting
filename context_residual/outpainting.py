...
class CompletionNetwork(nn.Module):
    def __init__(self, res_block):
        ...
        self.res_block1 = self.make_layer(res_block, 16)
        self.res_block2 = self.make_layer(res_block, 32)
        self.res_block3 = self.make_layer(res_block, 64)
        self.conv2 = nn.Conv2d(64, 128, kernel_size=1, stride=1, padding=1, bias=False)
    ...
    def make_layer(self, res_block, out_channels, num_blocks=2, stride=1):
        ...
        layers = [res_block(self.in_channels, out_channels, stride, downsample)]
...
class ContextDiscriminator(nn.Module):
    def __init__(self, local_input_shape, global_input_shape, arc='places2'):
        ...
        # For outpainting, local and global discriminator shapes are equal
